  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        <img src={selectedUser.profilePic || assets.avatar_icon} alt="profile_img" className='w-8 rounded-full' />
    ...
    <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 '>
          <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
            ...
            onKeyDown={(e)=>e.key === "Enter" ? handleSendMessage(e) : null} type="text" placeholder='Message...' 
    ...
    bg-white/10 max-md:hidden'>
      <img src={assets.nice_chat_logo} className='max-w-35' alt="" />
      <p className='text-3xl font-medium text-white'>Have a Nice Chat</p>
    </div>
  )
}
