...
const LoginPage = () => {
  ...
  return (
    ...
    sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      {/*...Left...*/}
      <img src={assets.nice_chat_logo} alt="" className='w-[min(35vw,300px)]'/>
      ...
      gap-6 rounded-lg shadow-lg'>
        ...
        {
          currState === "Sign up" && isDataSubmitted && (
            <textarea onChange={(e)=>setBio(e.target.value)} value={bio} rows={4} className='p-2 border border0gray-500
            rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='provide a short bio...'></textarea>
          )
        }

        <button type='submit' className='py-3 bg-gradient-to-r from-blue-400 to-sky-600
