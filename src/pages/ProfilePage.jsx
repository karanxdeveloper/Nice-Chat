    ...
    justify-center'>
      ...
      max-sm:flex-col-reverse rounded-lg'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
            ...
            className='p-2 border borde-gray-500 rounded-md foucs:outline-none
            focus:ring-2 focus:ring-blue-500' rows={4}></textarea>

            <button className='bg-gradient-to-r from-blue-400 to-sky-600
